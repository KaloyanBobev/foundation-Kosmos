    ...
    render() {
        return (
            <section className="books-container">
                ...
                <ul>
                    <li> „По прашните дюлени пътища</li>
                    <li> на босоногото детство</li>
                    <li> препускат пак спомени</li>
                    <li> събуждат ги слънчеви изгреви</li>
                    <li> приспиват ги вечерните залези…“</li>
                </ul>
