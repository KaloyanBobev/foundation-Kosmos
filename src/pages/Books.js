    ...
    render() {
        return (
            <section className="books-container">
                ...
                <p>
                    На 30 ноември 2013 г. в Регионална библиотека „Захарий Княжески“
                ...
                <p>
                    Двете книги на Димитър Брацов са ясен знак за това, че българското поетично слово
                ...
                <p>
                    В поезията и в прозата на този автор спомените са свещен дар в дългия житейски път на човека.
                ...
                <p>
                    Димитър Брацов остава верен на съпричастието си към радостта и към болката на човека. Но той не е някаква абстракция.
