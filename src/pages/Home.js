      ...
      <div className="container">
        <div className="border">
          ...
          >
            ...
            <span>
              <h2>Заповядайте на 21 април, петък, в 17.30 часа,</h2>
            </span>
            <span>
              <h2>в Залата на Регионална библиотека</h2>
            </span>
            <span>
              <pre>{`
"Захарий Княжески" на представянето на стихосбирката
"Аз съм всичко, което след мен ще остане"
 - избрано - в памет на
Стойчо Маджарски. Издадена е със спомоществователството
на Златен фонд към Фондация „КОСМОС – Димитър Брацов“
– Стара Загора.
                `}</pre>
            </span>
          </ReactReadLessMore>
