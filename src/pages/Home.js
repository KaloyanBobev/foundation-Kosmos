    ...
    return (
      <div className="container">
        <div className="border">
          ...
          >
            <span>
              <h1>Стартира подаването на творби за XII Национален конкурс</h1>
            </span>
            <span>
...
18 години. Конкурсът се организира от Община 
Стара Загора, Дружество на писателите – Стара Загора,
Фондация „Космос – Димитър Брацов“ и Регионална 
библиотека „Захарий Княжески“.  Провежда се всяка
година с подкрепата на старозагорските читалища 
„Николай Лилиев – 2005“ и „Даскал Петър Иванов – 1988“. 
В състава на журито са включени утвърдени имена от 
съвременния литературен живот. Медийни партньори на 
...
творби, непубликувани под каквато и да е форма към крайната 
дата на кандидатстване. Всеки автор изпраща имейл, съдържащ 
до 3 (три) поетични произведения на електронен адрес: 
n-liliev@abv.bg, в срок до 11 септември 2025 г.
...
личните данни на участника (три имена, дата, месец и 
година на раждане, пощенски адрес, телефон). 
Предоставените лични данни служат само за целите 
...
Изпращайки творбите си, авторите дават съгласието си имената 
и творбите им да бъдат публикувани в социалните мрежи, 
в печатни и електронни медии и публикации, свързани с конкурса.

Първа награда – Награда на Кмета на Община Стара Загора.
Втора награда – Награда на Фондация „Космос – Димитър Брацов“.
Трета награда – Награда на Народно читалище „Николай Лилиев – 2005“.
...
Отчитането на резултатите е на 1 октомври - Ден на 
българската поезия. Церемонията по награждаването 
е част от Есенни литературни дни - Стара Загора 2025 г.
